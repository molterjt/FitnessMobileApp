                                        ...
                                        <View key={id} style={{flexDirection: "column", margin: 5}}>
                                            ...
                                            {events.length !== 0
                                                ...
                                                (<View style={{borderBottomWidth: 1, borderColor: 'blue', padding: 3}}>
                                                    ...
                                                    {events.map(({name, time, date}) =>
                                                        <Text style={{fontSize: 12, fontStyle: 'italic', margin: 5, }}>{name} @ {time} on {date}</Text>
                                                    )}
                                                </View>)
                                                :
                                                null
                                            ...
                                            {classes.length !== 0
                                                ...
                                                (<View>
                                                    ...
                                                    {classes.map((obj, index) => (
                                                        <View style={{ padding: 2, width: width*.42, borderBottomWidth:1,  borderColor:"blue"}}>
                        ...
                        return (
                            <MapView.Marker key={index} coordinate={marker.coordinate} title={marker.title} >
                                <Animated.View style={[styles.markerWrap, opacityStyle]}>
                                    <Animated.View style={[styles.ring, scaleStyle]} alt={marker.title}/>
